...
public class CookieAuthenticationStateProvider : AuthenticationStateProvider,IAccountManager
{
    ...
    public CookieAuthenticationStateProvider(IHttpClientFactory httpClientFactory) => _httpClient = httpClientFactory.CreateClient(Constants.Auth);
    ...
    public async Task<ServiceResult> RegisterAsync(RegisterDTO model)
    {
        ...
        try
        {
            ...
            foreach (var errorEntry in Errors.EnumerateObject())
            {
            ...
            return ServiceResult.Fail(errors:problemDetails == null ? defaultDetail : [.. errors]);
        }
        catch { }

        // unknown error
        return ServiceResult.Fail(errors: defaultDetail);
    }
    ...
    public async Task<ServiceResult> LoginAsync(LoginDTO model)
    {
        ...
        // unknown error
        return ServiceResult.Fail(errors: "Invalid email and/or password.");
    }
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        try
        {
            ...
            var userInfo = JsonSerializer.Deserialize<UserDTO>(userJson, jsonSerializerOptions);
